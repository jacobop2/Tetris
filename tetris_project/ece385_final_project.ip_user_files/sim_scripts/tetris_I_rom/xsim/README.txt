...
#
# Generated by export_simulation on Sat Nov 11 13:22:23 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_I_rom.sh' script.

./tetris_I_rom.sh -reset_run
...
./tetris_I_rom.sh -noclean_files

For more information on the script, please type './tetris_I_rom.sh -help'.
