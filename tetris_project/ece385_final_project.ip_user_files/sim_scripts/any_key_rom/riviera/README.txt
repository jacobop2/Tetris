...
#
# Generated by export_simulation on Mon Nov 20 16:29:29 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './any_key_rom.sh' script.

./any_key_rom.sh -reset_run
...
./any_key_rom.sh -noclean_files

For more information on the script, please type './any_key_rom.sh -help'.
