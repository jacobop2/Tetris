...
#
# Generated by export_simulation on Tue Nov 14 14:27:45 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_Z_rom.sh' script.

./tetris_Z_rom.sh -reset_run
...
./tetris_Z_rom.sh -noclean_files

For more information on the script, please type './tetris_Z_rom.sh -help'.
