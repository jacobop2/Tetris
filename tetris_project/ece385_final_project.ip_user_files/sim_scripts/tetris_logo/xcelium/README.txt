...
#
# Generated by export_simulation on Fri Nov 10 16:26:43 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_logo.sh' script.

./tetris_logo.sh -reset_run
...
./tetris_logo.sh -noclean_files

For more information on the script, please type './tetris_logo.sh -help'.
