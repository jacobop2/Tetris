...
#
# Generated by export_simulation on Tue Nov 14 14:29:23 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_T_rom.sh' script.

./tetris_T_rom.sh -reset_run
...
./tetris_T_rom.sh -noclean_files

For more information on the script, please type './tetris_T_rom.sh -help'.
