...
#
# Generated by export_simulation on Tue Nov 14 14:26:37 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_S_rom.sh' script.

./tetris_S_rom.sh -reset_run
...
./tetris_S_rom.sh -noclean_files

For more information on the script, please type './tetris_S_rom.sh -help'.
