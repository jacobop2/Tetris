...
#
# Generated by export_simulation on Tue Nov 14 14:24:45 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_square_rom.sh' script.

./tetris_square_rom.sh -reset_run
...
./tetris_square_rom.sh -noclean_files

For more information on the script, please type './tetris_square_rom.sh -help'.
