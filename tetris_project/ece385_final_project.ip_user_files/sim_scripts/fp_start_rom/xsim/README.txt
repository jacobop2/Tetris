...
#
# Generated by export_simulation on Mon Nov 20 16:28:27 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './fp_start_rom.sh' script.

./fp_start_rom.sh -reset_run
...
./fp_start_rom.sh -noclean_files

For more information on the script, please type './fp_start_rom.sh -help'.
