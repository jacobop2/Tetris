...
#
# Generated by export_simulation on Sat Nov 11 18:20:37 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_board_ram.sh' script.

./tetris_board_ram.sh -reset_run
...
./tetris_board_ram.sh -noclean_files

For more information on the script, please type './tetris_board_ram.sh -help'.
