...
#
# Generated by export_simulation on Tue Nov 14 14:30:43 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './tetris_L_rom.sh' script.

./tetris_L_rom.sh -reset_run
...
./tetris_L_rom.sh -noclean_files

For more information on the script, please type './tetris_L_rom.sh -help'.
